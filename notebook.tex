...
{\color{outcolor}Out[{\color{outcolor}2}]:}         Date     Open     High      Low    Close      Volume    Market Cap
        0 2018-05-10  9325.96  9396.04  9040.52  9043.94  6906700000  158772000000
        1 2018-05-09  9223.73  9374.76  9031.62  9325.18  7226890000  157013000000
        2 2018-05-08  9380.87  9462.75  9127.77  9234.82  7415870000  159672000000
        3 2018-05-07  9645.67  9665.85  9231.53  9373.01  7394020000  164161000000
        4 2018-05-06  9845.31  9940.14  9465.25  9654.80  7222280000  167541000000
\end{Verbatim}
            
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}10}]:} \PY{n}{df} \PY{o}{=} \PY{n}{bitcoin\PYZus{}market\PYZus{}info}\PY{p}{[}\PY{p}{[}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{High}\PY{l+s+s1}{\PYZsq{}}\PY{p}{,}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{Date}\PY{l+s+s1}{\PYZsq{}}\PY{p}{]}\PY{p}{]}
         \PY{n}{df}\PY{o}{.}\PY{n}{to\PYZus{}csv}\PY{p}{(}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{new\PYZus{}data\PYZus{}set.csv}\PY{l+s+s1}{\PYZsq{}}\PY{p}{,}\PY{n}{index}\PY{o}{=}\PY{n+nb+bp}{False}\PY{p}{,}\PY{n}{header}\PY{o}{=}\PY{n+nb+bp}{False}\PY{p}{)}
\end{Verbatim}


    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}8}]:} \PY{c+c1}{\PYZsh{} get market info for ethereum from the start of 2016 to the current day}
...
\begin{Verbatim}[commandchars=\\\{\}]
{\color{outcolor}Out[{\color{outcolor}8}]:}         Date    Open    High     Low   Close      Volume   Market Cap
        0 2018-05-10  752.58  766.75  726.66  727.28  2748950000  74758700000
        1 2018-05-09  752.90  759.53  718.47  752.27  2877870000  74775300000
        2 2018-05-08  755.01  774.25  728.13  752.86  2920490000  74969200000
        3 2018-05-07  793.34  795.76  710.18  753.73  4316120000  78758700000
        4 2018-05-06  816.09  835.06  764.88  792.31  3105570000  81000200000
\end{Verbatim}
